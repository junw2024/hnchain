...
func (c *replyClient) Comments(ctx context.Context, in *CommentsReq, opts ...grpc.CallOption) (*CommentsRsp, error) {
	out := new(CommentsRsp)
...
type ReplyServer interface {
	Comments(context.Context, *CommentsReq) (*CommentsRsp, error)
...
func (UnimplementedReplyServer) Comments(context.Context, *CommentsReq) (*CommentsRsp, error) {
...
func _Reply_Comments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplyServer).Comments(ctx, req.(*CommentsReq))
	}
